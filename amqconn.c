/* @(#) samples/c/amqsput0.c, samples, p701, p701-105-110415 1.40.1.1 09/08/15 09:56:39 */
 /********************************************************************/
 /*                                                                  */
 ...
 int main(int argc, char **argv)
 {
   ...
   /* pmo.Options |= MQPMO_NEW_CORREL_ID;                            */
       ...
       md.Expiry=300;
       md.Report=MQRO_EXPIRATION_WITH_FULL_DATA;
       memset(md.ReplyToQ, 0, sizeof(md.ReplyToQ));
       memcpy(md.ReplyToQ, "T", sizeof(md.ReplyToQ));
